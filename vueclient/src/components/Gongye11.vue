    ...
    <el-main>
      ...
      <div class="text item">
        <pre>
          ...
          云速建站	1．支持PC、Mobile、APP、小程序、微信公众号
                  2．覆盖电商、餐饮和旅游等60+行业模板
                  3．不用懂代码，自由拖拽，轻松建站
          域名注册	1．企业品牌与知识产权保护必备
                  2．企业上云与数字化转型敲门砖
                  3．.com/.cn/.net等50余款域名任选
          定制建站	1．企业品牌与知识产权保护必备
                  2．企业上云与数字化转型敲门砖
                  3．.com/.cn/.net等50余款域名任选
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getOneProduct?product_id=27").then(resp => {
        if (resp.status == 200) {

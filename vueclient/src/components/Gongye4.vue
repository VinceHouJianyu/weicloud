    ...
    <el-main>
      ...
      <div class="text item">
        <pre>
          ...
          智能光伏EL缺陷识别——	降低用工成本，帮助光伏企业提质增效
          WMS仓储管理系统	——为企业仓储管理提供智能化解决方案
          SWMS-仓库管理系统	——实现智能仓储管理
          追踪和追溯产品真实性解决方案	——改善分销渠道和客户关系管理
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getOneProduct?product_id=17").then(resp => {
        if (resp.status == 200) {

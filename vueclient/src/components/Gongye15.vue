    ...
    <el-main>
      ...
      <div class="text item">
        <pre>
          ...
          公司注册	1．快至3天拿执照，1对1专业顾问
                  2．贴心服务全程代办，免见面
                  3．在家就能开公司，助您快速创业
          商标注册	1．保护企业从保护品牌开始，专业人做专业事
                  2．大数据+高级顾问，1对1解析注册风险
                  3．免见面，全在线注册，全程托管式服务
          VI与LOGO设计	1．精选必备设计项目，低价打造品牌视觉
                      2．官方先行验收，全程项目监理
                      3．专业设计师，定制风格与寓意
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getOneProduct?product_id=31").then(resp => {
        if (resp.status == 200) {

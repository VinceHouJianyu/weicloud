  ...
  <el-container  >
    ...
    <el-main>
      ...
      <div class="text item">
        ...
        商品说明
          应用：
          Legacy系统与CloudNative应用协同	1．混合云应用级互通
                                        2．非侵入式改造
                                        3．沉淀企业IT核心资产和经验
          跨地域、跨云数据共享交换	1．跨域集成
                                2．跨云集成
                                3．跨网集成
                                4．打破信息孤岛
          IT与OT融合	1．设备数字化，联接物理世界与数字世界
                    2．云与本地、合作伙伴间的应用与数据集成， 打通企业OT与IT
                    3．构建集成中台，打造数据底座，实现数据共享及可视化
          多场景应用与异构数据入湖	1．边缘计算能力
                                2．汇聚多地域多种异构数据源
                                3．简单、高效的开放
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getOneProduct?product_id=26").then(resp => {
        if (resp.status == 200) {

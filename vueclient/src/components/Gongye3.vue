    ...
    <el-main>
      ...
      <div class="text item">
        <pre>
          ...
          财务供应链	——实现财务、供应链、生产管理等
          T+Cloud 解决方案	——财务管理、进销存管理解决方案
          SRM解决方案	——助力企业快速完成采购数字化转型
          ERP解决方案	——集人财物客、产供销于一体的ERP方案
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getOneProduct?product_id=16").then(resp => {
        if (resp.status == 200) {

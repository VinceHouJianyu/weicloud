  ...
  <el-container >
    <el-main>
      <el-card class="box-card" v-for="(product,index) in products" :key="index">
        ...
        <div v-if="product.product_type == 2">
          <div slot="header" class="clearfix">
            <span>工业互联网</span>
          </div>
          <div class="text item">
        ...
        <div v-if="product.product_type == 3">
          <div slot="header" class="clearfix">
            <span>企业应用</span>
          </div>
          <div class="text item">
        ...
        <div v-if="product.product_type == 4">
          <div slot="header" class="clearfix">
            <span>云基础资源</span>
          </div>
          <div class="text item">
...
<script>
  ...
  export default {
    mounted: function () {
      var _this = this;
      getRequest("/product/getAllProduct?product_type=0").then(resp => {
        if (resp.status == 200) {
